...
const Hero = () => {
  return (
    <section className="relative overflow-hidden min-h-[600px] md:min-h-[700px]">
      ...
      {/* <div className="relative z-10 max-w-7xl mx-auto my-12 px-4 sm:px-6 lg:px-8">
  ...
  <div className="py-32 lg:py-40 max-w-2xl mx-auto md:mx-0 md:ml-40 text-center md:text-left">
