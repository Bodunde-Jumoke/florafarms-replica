        ...
        <section className="py-16 bg-background">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="border-l-4 border-farm-orange bg-card p-6 mb-8">
              {sections[0] && (
                <>
                  <h3 className="font-sans font-bold text-sm text-foreground mb-3">
                    {sections[0].title}
                  </h3>
            ...
            <div className="border-l-4 border-farm-orange bg-card p-6 mb-8">
              {sections.slice(1).map((section, i) => (
                <div key={i} className={i > 0 ? "mt-4" : ""}>
                  <h3 className="font-sans font-bold text-sm text-foreground mb-2">
                    {section.title}
                  </h3>
                  {section.content.map((p, j) => (
                    <p key={j} className="text-muted-foreground text-sm leading-relaxed mb-2 last:mb-0">
                      {p}
                    </p>
                  ))}
                </div>
            ...
            <a
              href="/contact"
              className="block w-full bg-farm-orange hover:bg-farm-orange-hover text-primary-foreground text-center py-3 rounded-full font-semibold transition-colors text-sm"
            >
              Contact Us Today
            </a>
          </div>
